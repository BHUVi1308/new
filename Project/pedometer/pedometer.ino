...
const char* ssid = "KRISHNA 4313"; // replace with your WiFi network name (SSID)
const char* password = "Radha@108"; // replace with your WiFi network password
const char* server_ip = "192.168.137.13"; // replace with your PC's IP address
